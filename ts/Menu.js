...
(function (FloodTactics) {
    var Menu = (function (_super) {
        ...
        Menu.prototype.create = function () {
            ...
            var level1Button = this.game.add.button(313, 310, 'level1', function () { _this.game.state.start('Level', true, false, 'level3.json'); }, this); //4. parametr je parametrem init funkce
