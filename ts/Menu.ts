...
module FloodTactics {
    ...
    export class Menu extends Phaser.State {
        ...
        create() {
			...
			var level1Button = this.game.add.button(313, 310, 'level1', () => {this.game.state.start('Level', true, false, 'calibration.json'); }, this);	//4. parametr je parametrem init funkce
